...
object StdNames {
  ...
  abstract class DefinedNames[N <: Name] {
    ...
    final val keywords: scala.collection.Set[N] = kws
  }


  abstract class PsiNames[N <: Name] extends DefinedNames[N] {
    protected def encode(s: String): N = fromName(fromString(s).encode)

    final val ABSTRACTkw:  N = kw("abs")
    final val CASEkw:      N = kw("case")
    final val CATCHkw:     N = kw("catch")
    final val CLASSkw:     N = kw("cls")
    final val ELSEkw:      N = kw("else")
    final val ENUMkw:      N = kw("enum")
    final val FALSEkw:     N = kw("false")
    final val FINALLYkw:   N = kw("finally")
    final val FINALkw:     N = kw("fin")
    final val FNkw:        N = kw("fn")
    final val FORkw:       N = kw("for") // so sad that we need to have for for for-comprehension
    final val IFkw:        N = kw("if")
    final val IMPORTkw:    N = kw("use")
    final val LETkw:       N = kw("let")
    final val MATCHkw:     N = kw("match")
    final val NEWkw:       N = kw("new")
    final val NULLkw:      N = kw("null")
    final val OBJECTkw:    N = kw("obj")
    final val OPkw:        N = kw("op")
    final val OVERRIDEkw:  N = kw("ovr")
    final val PACKAGEkw:   N = kw("pkg")
    final val IMPLICITkw:  N = kw("impl")
    final val PROTECTEDkw: N = kw("pro")
    final val PUBLICkw:    N = kw("pub")
    final val RETURNkw:    N = kw("ret")
    final val SEALEDkw:    N = kw("seal")
    final val STRUCTkw:    N = kw("struct")
    ...
    val BITMAP_NORMAL:              N = BITMAP_PREFIX
    val BITMAP_TRANSIENT:           N = BITMAP_PREFIX + "trans$"
    val BITMAP_CHECKINIT:           N = BITMAP_PREFIX + "init$"
    val BITMAP_CHECKINIT_TRANSIENT: N = BITMAP_PREFIX + "inittrans$"
    ...
    final val Void:    N = "Void"
    final val Qubit:   N = "Qubit"

    final val PsiValueNames: _root_.scala.List[N] = _root_.scala.List(
      Boolean, Byte, Char, Double, Float,
      Int, Long, Short, Void, Qubit
    )

    final val AnyRef:      N = "AnyRef"
    final val Array:       N = "Arr"
    ...
    final val NO_NAME:        N = "<none>"
    final val WILDCARD_ALL:   N = ".."
    final val WILDCARD_UNDEF: N = "?"
    ...
    final val Not:                  N = "!"
    final val NotEqulals:           N = "!="
    final val NumberOfLeadingZeros: N = "NumberOfLeadingZeros"
    final val Or:                   N = "||"
    final val Plus:                 N = "+"
    final val S:                    N = "S" // oh boy i sure do wish there was an entire fucking variable for the string "S". The ever helpful Dotty:
    ...
    // what the fuck is a bean property
    ...
    final val RuntimeVisibleAnnotationATTR:   N = "RuntimeVisibleAnnotations"
    final val RuntimeInvisibleAnnotationATTR: N = "RuntimeInvisibleAnnotations"
    final val RuntimeParamAnnotationATTR:     N = "RuntimeVisibleParameterAnnotations"
    final val PsiATTR:                        N = "Psi"
    final val PsiSignatureATTR:               N = "PsiSig"
    ...
    def wrapRedArray: N = "wrapRefArray"
    def wrapXArray(cname: Name): N = "wrap" + cname + "Array"
    ...
    val zip: N                  = "zip"
    val `++` : N                = "++"
    val nothingRuntimeClass: N  = "psi.runtime.Nothing$"
    val nullRuntimeClass: N     = "psi.runtime.Null$"
    ...
    val NumberOpNames   = Set[Name](ADD, SUB, MUL, DIV, MOD, LSL, LSR, ASR, LT, LE, GE, GT)
      ++ Set[Name](UNARY_+, UNARY_-, UNARY_!)
      ++ ConversionNames
      ++ CommonOpNames
  ...
  class PsiTermNames extends PsiNames[TermName] {
  ...
  class PsiTypeNames extends PsiNames[TypeName] {
  ...
  val nme: PsiTermNames = new PsiTermNames
  val tpnme: PsiTermNames = new PsiTermNames
}
