 ...
 * com/github/scala/scala3/compiler/src/dotty/tools/dotc/util/Chars.scala
 */
...
object chars
{
  ...
  inline val LF = '\u000A' // Newline         \n
  inline val CR = '\u000D' // Carriage Return \r   Part of newline on Windows
  inline val FF = '\u000C' // Form Feed       ^L   Moves the page up
  inline val SU = '\u001A' // Substitute      ^Z   EOF marker sometimes
